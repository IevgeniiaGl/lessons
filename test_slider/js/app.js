(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".quick-bytes__slider")) new core(".quick-bytes__slider", {
            ...
            navigation: {
                prevEl: "._icon-arrow_prev",
                nextEl: "_icon-arrow_next"
            },
            on: {}
        });
    }
    ...
    class ScrollWatcher {
        ...
        scrollWatcherIntersecting(entry, targetElement) {
            if (entry.isIntersecting) {
                !targetElement.classList.contains("_watcher-view") ? targetElement.classList.add("slide-top") : null;
                this.scrollWatcherLogging(`Я бачу ${targetElement.classList}, додав клас slide-top`);
            } else {
